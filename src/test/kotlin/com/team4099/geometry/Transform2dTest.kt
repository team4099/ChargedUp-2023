...
class Transform2dTest {
  ...
  fun testInverse() {
    ...
    val transform = Transform2d(Translation2d(5.0.meters, 0.0.meters), 5.0.degrees)
  ...
  fun testComposition() {
    val initial = Pose2d(Translation2d(1.0.meters, 2.0.meters), 45.0.degrees)
    val transform1 = Transform2d(Translation2d(5.0.meters, 0.0.meters), 5.0.degrees)
    val transform2 = Transform2d(Translation2d(0.0.meters, 2.0.meters), 5.0.degrees)
