...
class Twist2dTest {
  ...
  @Test
  fun testStraight() {
    val straight = Twist2d(5.0.meters.perSecond, 0.0.meters.perSecond, 0.0.radians.perSecond)
  ...
  fun testQuarterCircle() {
    val quarterCircle =
      Twist2d(
        (5.0 / 2.0 * Math.PI).meters.perSecond,
        0.0.meters.perSecond,
        (Math.PI / 2.0).radians.perSecond
      )
  ...
  fun testDiagonalNoDtheta() {
    val diagonal = Twist2d(2.0.meters.perSecond, 2.0.meters.perSecond, 0.0.radians.perSecond)
  ...
  @Test
  fun testEquality() {
    val one = Twist2d(5.meters.perSecond, 1.meters.perSecond, 3.radians.perSecond)
    val two = Twist2d(5.meters.perSecond, 1.meters.perSecond, 3.radians.perSecond)
    assertEquals(one, two)
  }

  @Test
  fun testInequality() {
    val one = Twist2d(5.meters.perSecond, 1.0.meters.perSecond, 3.radians.perSecond)
    val two = Twist2d(5.meters.perSecond, 1.2.meters.perSecond, 3.radians.perSecond)
