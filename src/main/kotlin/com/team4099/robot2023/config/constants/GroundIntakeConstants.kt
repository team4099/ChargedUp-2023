...
object GroundIntakeConstants {
  ...
  object PID {
    ...
    val ARM_KG = 0.59721.volts
    val ARM_KV = 1.1.volts / 1.0.radians.perSecond
    val ARM_KA = 0.065.volts / 1.0.radians.perSecond.perSecond
  }
  ...
  val ABSOLUTE_ENCODER_OFFSET = -33.89.degrees
  ...
  val STOWED_UP_ANGLE = 56.6.degrees // TODO change back to 56.6
